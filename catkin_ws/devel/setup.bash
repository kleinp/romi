...
# export Gazebo paths
export GAZEBO_PLUGIN_PATH=$GAZEBO_PLUGIN_PATH:$CATKIN_SETUP_DIR"/../src/romi_description/plugin/build/"
...
export GAZEBO_MODEL_PATH=$GAZEBO_MODEL_PATH:$CATKIN_SETUP_DIR"/../src/"
